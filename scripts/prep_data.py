...
src = 'hf://datasets/COGNANO/VHHCorpus-2M/' + splits['train']
...
df2.write_csv(out_dir / 'vhh_2M.tsv', separator='\t')
df2.sample(n=200, seed=0).write_csv(out_dir / 'vhh_200.tsv', separator='\t')
df2.sample(n=2000, seed=0).write_csv(out_dir / 'vhh_2K.tsv', separator='\t')
df2.sample(n=20000, seed=0).write_csv(out_dir / 'vhh_20K.tsv', separator='\t')
df2.sample(n=200000, seed=0).write_csv(out_dir / 'vhh_200K.tsv', separator='\t')
